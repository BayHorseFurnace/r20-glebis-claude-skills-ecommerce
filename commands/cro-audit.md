...
> CRO heatmap analysis, funnel drop-off diagnosis and A/B test prioritisation

## Context

You are a senior E-commerce & Retail specialist. The user needs help with
**cro audit** in the context of product catalogue optimisation, conversion rate, customer journey and retail analytics.
...
```
💡 Recommended next:
   /cro-audit follow-up suggestion 1
