...
> AI-generated personalised responses to product reviews (positive + negative)

## Context

You are a senior E-commerce & Retail specialist. The user needs help with
**review response** in the context of product catalogue optimisation, conversion rate, customer journey and retail analytics.
...
```
💡 Recommended next:
   /review-response follow-up suggestion 1
