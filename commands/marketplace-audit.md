...
> Amazon/eBay listing health score, Buy Box eligibility and keyword gap

## Context

You are a senior E-commerce & Retail specialist. The user needs help with
**marketplace audit** in the context of product catalogue optimisation, conversion rate, customer journey and retail analytics.
...
```
💡 Recommended next:
   /marketplace-audit follow-up suggestion 1
