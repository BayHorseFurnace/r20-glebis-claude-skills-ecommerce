...
> Demand forecasting report with reorder points and safety stock calculation

## Context

You are a senior E-commerce & Retail specialist. The user needs help with
**inventory forecast** in the context of product catalogue optimisation, conversion rate, customer journey and retail analytics.
...
```
💡 Recommended next:
   /inventory-forecast follow-up suggestion 1
