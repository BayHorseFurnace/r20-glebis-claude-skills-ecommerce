        ...
        ### Derived from [glebis/claude-skills](https://github.com/glebis/claude-skills)
        ...
        > **Adaptation of `glebis/claude-skills` for E-commerce & Retail use cases.**
        > Source focus: _cognitive toolkit, image gen, browser history, research skills_
        ...
        **5 multi-step workflows**, all with a consistent
        ...
        ```bash
        # Clone this skill
        cp -r . ~/.claude/skills/r00-glebis-claude-skills--ecommerce/

        # Register in Claude Code
        # In a Claude Code session:
        /read ~/.claude/skills/r00-glebis-claude-skills--ecommerce/SKILL.md
        ```
...
```
        ...
        **[glebis/claude-skills](https://github.com/glebis/claude-skills)**
        which focuses on: _cognitive toolkit, image gen, browser history, research skills_.
